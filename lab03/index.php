...
<head>
    ...
    <title>Browser: <?php echo $current_dir ? $current_dir : 'Lab 03'; ?></title>
        ...
        <div class="header">
            <div>
                <h2>
                    ...
                    <?php else: ?>
                        <i class="fas fa-home"></i> Lab 03 Root
                    <?php endif; ?>
                </h2>
                <div class="breadcrumb">Vị trí: Lab03/<?php echo $current_dir; ?></div>
            </div>
