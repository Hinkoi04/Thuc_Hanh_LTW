...
*/
    function BCC($n, $colorHead = "green", $color1 = "blue", $color2 = "pink")
    {
        $html = "<table>" . "<tr><td colspan='3' style='background-color: <?php echo $colorHead; ?>;'>Bảng cửu chương <?php echo $n; ?></td>
    </tr>";
    ...
    function BanCo($size = 8)
    {
        ...
        for ($i = 1; $i <= $size; $i++) {
            for ($j = 1; $j <= $size; $j++) {
                ...
                $html.= "<div class='$classCss'> $i - $j</div>"."<div class='clear' /></div>";
            }
        }
        return $html;
    }
