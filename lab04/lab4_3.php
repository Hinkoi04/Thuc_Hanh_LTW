...
$b1 = $b;
rsort($b1);
echo "Mảng b sau khi sắp xếp giảm dần xóa key:";
showArray($b1);

$b2 = $b;
arsort($b2);
echo "<br>Mảng b sau khi sắp xếp giảm dần theo giá trị giữ key:";
showArray($b2);

$b3 = $b;
krsort($b3);
echo "<br>Mảng b sau khi sắp xếp giảm dần theo key :";
showArray($b3);
