...
<head>
    ...
    <title>Browser: <?php echo $current_dir ? $current_dir : 'Lab 04'; ?></title>
        ...
        <div class="header">
            <div>
                <h2>
                    ...
                    <?php else: ?>
                        <i class="fas fa-home"></i> Lab 04 Root
                    <?php endif; ?>
                </h2>
                <div class="breadcrumb">Vị trí: Lab04/<?php echo $current_dir; ?></div>
            </div>
