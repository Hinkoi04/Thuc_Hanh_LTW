...
<head>
    ...
    <title>Browser: <?php echo $current_dir ? $current_dir : 'Lab 01'; ?></title>
        ...
        <div class="header">
            <div>
                <h2>
                    ...
                    <?php else: ?>
                        <i class="fas fa-home"></i> Lab 01 Root
                    <?php endif; ?>
                </h2>
                <div class="breadcrumb">Vị trí: Lab01/<?php echo $current_dir; ?></div>
            </div>
