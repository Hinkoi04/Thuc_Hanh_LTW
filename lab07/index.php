...
<head>
    ...
    <title>Browser: <?php echo $current_dir ? $current_dir : 'Lab 07'; ?></title>
        ...
        <div class="header">
            <div>
                <h2>
                    ...
                    <?php else: ?>
                        <i class="fas fa-home"></i> Lab 07 Root
                    <?php endif; ?>
                </h2>
                <div class="breadcrumb">Vị trí: Lab07/<?php echo $current_dir; ?></div>
            </div>
